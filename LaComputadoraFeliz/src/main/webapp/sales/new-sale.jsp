    ...
    <body>
        ...
        <div class="d-flex justify-content-center align-items-center vh-80">
            <div class="contenedor-login">
                ...
                <form method="POST" action="${pageContext.servletContext.contextPath}/controllers/customer-loader">
                    <div class="mb-3">
                        <label for="nit" class="form-label">Nit</label>
                        <input type="text" class="form-control" id="nit" name="nit" placeholder="Ingresa un nit" required>
                    </div>
