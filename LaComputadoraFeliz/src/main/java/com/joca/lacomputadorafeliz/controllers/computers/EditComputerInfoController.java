 ...
 * @author joca
 */
@WebServlet(name = "EditComputerInfoController", urlPatterns = {"/controllers/edit-computer-servlet"})
public class EditComputerInfoController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            adminComputers.updateInfoComputer(request);
            request.setAttribute("success", true);
            request.setAttribute("message", "Computadora actualizada con exito");
